...
//		alert("test");
		...
		if ($this->form_validation->run() == FALSE) {
			$this->load->view('partner/memberWrite',$data);
	...
	function add()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$this->load->view('partner/memberAdd',$data);
	...
	function addressList()
	{
		...
		$this->load->view('partner/memberAddress',$data);
	...
	function exchange()
	{
		...
		$this->load->view('partner/memberExchange',$data);	
	}
	...
	function bank()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$this->load->view('partner/memberBank',$data);
	...
	function send()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$this->load->view('partner/memberSend',$data);
	...
	function  multicoinsend(){
		...
		if( $this->session->userdata('level') == "10") {
			...
			if ($this->form_validation->run() == FALSE) {
				$this->load->view('partner/memberCoinSends', $data);
			} else {
				...
				$this->load->view('partner/memberCoinSends_result', $data);
	...
	function coinsend()
	{
		...
		if( $this->session->userdata('level') == "10") {
			...
			if ($this->form_validation->run() == FALSE) {
				$this->load->view('partner/memberCoinSend', $data);
			} else {
...
/*=============================================================================================================*/
	...
	function history()
	{
		...
		$this->load->view('partner/memberHistory',$data);

...
<div class="container">
		...
		<div class="row">
			<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
				<div class="card card-signup" style='box-shadow: 2px 2px 4px #ff1100;border:none;'>
					...
					<p class="text-divider" style="margin-bottom:20px;font-weight: 500;text-shadow: 2px 2px 3px #b0b0b0;color: #444;">JOIN US</p>
					<div class="content">
						<div class="input-group" style="margin-bottom:20px">
							<span class="input-group-addon">
								<!-- <i class="material-icons" style='font-style:normal;font-weight:600;'>Face</i> -->
								<i class="material-icons">email</i>
							</span>
							<input name="member_id" type="text" class="form-control" placeholder="Member Email" value="<?=$userid?>" required />
						</div>
						<div class="input-group">
							<span class="input-group-addon">
								<!-- <i class="material-icons" style='font-style:normal;font-weight:600;'>Lock Outline</i> -->
					...
					<div class="footer text-center">
						<input type="submit" class="btn btn-success" style="background-image: url(<?php echo base_url('views/web/app/img/bg_ft.png'); ?>);background-size: cover; background-position: top center; margin-top:30px;background: #000000;background: -webkit-linear-gradient(to left, #e74c3c, #000000);background: linear-gradient(to left, #e74c3c, #151111);box-shadow: 1px 1px 4px grey;" value="Login">
					</div>
					<div class="input-group">
						<span class="input-group-addon">
							<h6 style="margin:0; padding:0; lineheight:0"><a href="/app/register" style="color:#0d88c0;">Sign Up<a/><h6>
                            <h6 style="margin:0; padding:0; lineheight:0"><a href="/app/seed/recovery" style="color:#0d88c0;">Wallet recovery<a/></h6>
						</span>

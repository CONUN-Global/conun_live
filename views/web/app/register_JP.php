                ...
                <div class="card card-signup">
                    <form name="reg_form" action="<?=current_url()?>" method="post" onsubmit="return formCheck();">
                        ...
                        <div class="header text-center" style="background-image: url(<?php echo base_url('views/web/app/img/bg_ft.png'); ?>);background-size: cover; background-position: top center;">
                            <h3>Sign Up</h3>
                            <br>sign up for a free wallet below
                        </div>
                        ...
                        <div class="content">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                     <button class="btn btn-info    tx-11 tx-spacing-2 btn-sm" style="margin-top: 20px" onclick="emaiAuth(); return false;" >Send</button>
                                    </span>
                            ...
                            <div class="input-group">
									<span class="input-group-addon">
										<i class="material-icons">Email Code</i>
									</span>
                                <input autocomplete="off"id="mail_code" name="mail_code" type="text" class="form-control" placeholder="Email Code"   required>
                                <span class="input-group-btn">
                                     <button class="btn btn-info    tx-11 tx-spacing-2 btn-sm" style="margin-top: 20px" onclick="mailcheck(); return false;" >Confirm</button>
                                    </span>
                            ...
                            <div class="checkbox">
                                <label>
                                    ...
                                    have read and agree
                                    <button class="btn btn-info    tx-11 tx-spacing-2 btn-sm" style="margin-top: 10px" onclick="show_divpop(); return false;" >表示</button>
                                </label>
                            </div>
                        </div>
                        <div class="footer text-center">
                            <input autocomplete="off"type="submit" id="btn_submit" onclick=”this.disabled=true” class="btn btn-success" style="background-image: url(<?php echo base_url('views/web/app/img/bg_ft.png'); ?>);background-size: cover; background-position: top center;" value="CONTINUE">
                        </div>
                        <div class="input-group">
							<span class="input-group-addon">
							<h6><a href="/app" style="color: #000000"> Login<a/><h6>
							</span>
                        </div>
                        <br>
                    </form>
...
<script type="text/javascript">
    ...
    function formCheck()
    {
        ...
        if (f.wallet_password.value != f.wallet_password2.value ) {
            alert("WithDraw Passwords do not match.");
            f.wallet_password.focus();
            return false;
        }

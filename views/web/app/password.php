	            ...
	            <div class="col-md-8">
	                <div class="card">
	                    <div class="card-header" style="line-height:12px; padding-top:30px; background:#5cb360; color:#fff">
	                        <h4 class="title" style="font-size:18px; font-weight:bold">Change password</h4>
	    ...
	    <div class="container-fluid" style=" margin-top: 20px;">
		    <div class="row">
	            <div class="col-md-8">
	                <div class="card">
	                    <div class="card-header" style="line-height:12px; padding-top:30px; background:#5cb360; color:#fff">
	                        <h4 class="title" style="font-size:18px; font-weight:bold">비밀번호 수정하기</h4>
	    ...
	    <div class="container-fluid" style=" margin-top: 20px;">
		    <div class="row">
	            <div class="col-md-8">
	                <div class="card">
	                    <div class="card-header" style="line-height:12px; padding-top:30px; background:#5cb360; color:#fff">
	                        <h4 class="title" style="font-size:18px; font-weight:bold">パスワードを変更する。</h4>
	    ...
	    <div class="container-fluid" style=" margin-top: 20px;">
		    <div class="row">
	            <div class="col-md-8">
	                <div class="card">
	                    <div class="card-header" style="line-height:12px; padding-top:30px; background:#5cb360; color:#fff">
	                        <h4 class="title" style="font-size:18px; font-weight:bold">修改密码</h4>

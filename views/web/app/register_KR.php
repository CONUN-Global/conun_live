...
<script type="text/javascript" src="<?=SKIN_DIR?>/js/register_KR.js?version=2"></script>
<!-- 팝업 엔터로 레이어 닫기 -->
                        ...
                        <div class="content">
                            <div class="input-group">
									<span class="input-group-addon">
										<i class="material-icons">이름</i>
									</span>
                                <input autocomplete="off"name="member_name" type="text" placeholder="이름" class="form-control" required />
                            </div>
                            <div class="input-group">
									<span class="input-group-addon">
										<i class="material-icons">이메일</i>
									</span>
                                <input autocomplete="off"id="member_id" name="member_id" type="text" class="form-control" placeholder="이메일"  onblur='idcheck();' required>
                                <span class="input-group-btn">
                                     <button class="btn btn-info    tx-11 tx-spacing-2 btn-sm" style="margin-top: 20px" onclick="emaiAuth(); return false;" >전송</button>
                                    </span>
                            ...
                            <div class="input-group">
									<span class="input-group-addon">
										<i class="material-icons">이메일 인증</i>
									</span>
                                <div class="input-group">
                                    <input autocomplete="off"type="text" class="form-control" name="mail_code" placeholder="이메일 인증코드" required>
                                    <span class="input-group-btn">
                                     <button class="btn btn-info    tx-11 tx-spacing-2 btn-sm" style="margin-top: 20px" onclick="mailcheck(); return false;" >확인</button>
                                    </span>
                                </div>
                            ...
                            <div class="input-group">
                                ...
                                <input autocomplete="off"name="password" type="password" placeholder="지갑 새암호 입력" class="form-control" required />
                            </div>
                            <div class="input-group">
									<span class="input-group-addon">
										<i class="material-icons">비밀번호 확인</i>
									</span>
                                <input autocomplete="off"name="password2" type="password" placeholder="암호를 확인" class="form-control" required />
                            </div>
                            ...
                            <div class="input-group">
									<span class="input-group-addon">
										<i class="material-icons">출금 비밀번호</i>
									</span>
                                <input autocomplete="off"name="wallet_password" type="password" onkeypress="onlyNumber();" placeholder="출금 새암호 입력" class="form-control" required />
                            </div>
                            <div class="input-group">
									<span class="input-group-addon">
										<i class="material-icons">출금 비밀번호 확인</i>
									</span>
                                <input autocomplete="off"name="wallet_password2"  onkeypress="onlyNumber();" type="password" placeholder="출금 암호를 확인" class="form-control" required />
                            </div>
                            ...
                            <div class="checkbox">
                                <label>
                                    ...
                                    <span style="font-size: 12px">사용 조건을 읽었고 동의합니다.</span>

                                     <button class="btn btn-info    tx-11 tx-spacing-2 btn-sm" style="margin-top: 10px" onclick="show_divpop(); return false;" >보기</button>

                            </div>
                        </div>
                        <div class="footer text-center">
                            <input autocomplete="off"type="submit" id="btn_submit" onclick=”this.disabled=true” class="btn btn-success" style="background-image: url(<?php echo base_url('views/web/app/img/bg_ft.png'); ?>);background-size: cover; background-position: top center;" value="전자지갑 만들기">
                        </div>
                        <div class="input-group">
								<span class="input-group-addon">
									<h6><a href="/app" style="color: #000000"> 로그인하기<a/><h6>
								</span>
                        </div>
                        <br>
                    </form>

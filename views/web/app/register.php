...
<script type="text/javascript" src="<?=SKIN_DIR?>/js/register.js?<?=today()?>"></script>
...
<div class="header header-filter" style="background-image: url(<?php echo base_url('views/web/app/img/bg_effect21.png'); ?>); background-size: cover; background-position: top center;">
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
                <div class="card card-signup" style='border:none;box-shadow: 0px 2px 5px black;'>
                    <form name="reg_form" action="<?=current_url()?>" method="post" onsubmit="return formCheck();" autocomplete="off">
                        ...
                        <div class="header text-center" style="text-shadow: 2px 2px 4px grey;padding:10px 0; font-size:23px; background:linear-gradient(60deg, #0d88c0, #48b57f); color:#fff;    background: linear-gradient(90deg, rgba(210,212,196,1) 0%, rgba(136,108,90,1) 85%, rgba(136,108,90,1) 100%);">
                            <h3 style="font-size:23px;margin-bottom:20px;">Sign Up</h3>
                            <p style="font-size:16px">sign up for a free wallet below</p>
                        </div>
                        ...
                        <div class="content">
                            <div class="input-group">
                                ...
                                <input autocomplete="off" name="member_name" type="text" placeholder="name" class="form-control" required />
                            </div>
                            <div class="input-group" style="margin-bottom:20px">
                                ...
                                <input autocomplete="off"id="member_id" name="member_id" type="text" class="form-control" placeholder="Email..."  onblur='idcheck();' required>
                                <span class="input-group-btn">
                                     <button class="btn btn-info    tx-11 tx-spacing-2 btn-sm" style="margin-top: 20px" onclick="mailcheck(); return false;" >send</button>
                                </span>
                            ...
                            <div class="input-group" style="margin-bottom:20px">
                                ...
                                <input autocomplete="off"id="mail_code" name="mail_code" type="text" class="form-control" placeholder="Email code."  required>
                                <span class="input-group-btn">
                                     <button class="btn btn-info    tx-11 tx-spacing-2 btn-sm" style="margin-top: 20px" onclick="emaiAuth(); return false;" >Confirm</button>
                                    </span>
                            ...
                            <div class="input-group" style="margin-bottom:20px">
                                ...
                                <input autocomplete="off"name="password" type="password" placeholder="New Password" class="form-control"  required/>
                            </div>
                            <div class="input-group">
								<span class="input-group-addon">
									<i class="material-icons">lock_outline</i>
								</span>
                                <input autocomplete="off"name="password2" type="password" placeholder="Confirm Password" class="form-control"  required/>
                            </div>
                            <div class="input-group" style="margin-bottom:20px">
								<span class="input-group-addon">
									<i class="material-icons">lock</i>
                                ...
                                <input autocomplete="off"name="wallet_password" type="password" placeholder="  WithDraw New Password" class="form-control"  required/>
                            </div>
                            <div class="input-group">
								<span class="input-group-addon">
									<i class="material-icons">lock_outline</i>
								</span>
                                <input autocomplete="off"name="wallet_password2" type="password" placeholder="  WithDraw Confirm Password" class="form-control"  required/>
                            </div>


                            <div class="checkbox">
                                <label>
                                    <input autocomplete="off"type="checkbox" name="optionsCheckboxes" required />
                                    have read and agree
                                    <button class="btn btn-info    tx-11 tx-spacing-2 btn-sm" style="margin-top: 10px" onclick="show_divpop(); return false;" >See</button>
                                </label>
                            </div>

                        </div>
                        <div class="footer text-center">
                            <input autocomplete="off"type="submit" id="btn_submit" onclick=”this.disabled=true” class="btn btn-success" style="background-image: url(<?php echo base_url('views/web/app/img/bg_ft.png'); ?>);background-size: cover; background-position: top center;    background: linear-gradient(20deg, rgba(136,108,90,1) 0%, #ebe4e1 100%, rgb(51, 44, 40) 100%);
                                    box-shadow: 1px 1px 4px grey;" value="CONTINUE">
                        </div>
                        <div class="input-group">
							<span class="input-group-addon" style='padding-top:0;'>
								<h6><a href="/app" style="width: 122px;height: 41px;background-color: red;display: inline-flex;align-items: center;justify-content: center;border-radius: 3px;background: linear-gradient(200deg, rgba(136,108,90,1) 0%, #ebe4e1 100%, rgb(51, 44, 40) 100%);box-shadow: 1px 1px 4px grey;color: #fff;"> Login<a/><h6>
							</span>
                        </div>
                        <br>
                    </form>
...
<script type="text/javascript">
    function mailcheck() {
        ...
        if (document.getElementById('member_id_enabled').value != '000') {
            ...
            alert("Please enter your email verification number");
            f.auth_number.focus();
            return false;
        }

        else if(f.auth_number.value != f.mail_code.value ){
            alert("E-mail confirmation numbers do not match");
            f.auth_number.focus();
            return false;
        }
        else  {
    ...
    function formCheck()
    {
        ...
        if (f.wallet_password.value == "") {
            alert("WithDraw New Password");
            f.wallet_password.focus();
            return false;
        }


        if (f.wallet_password2.value == "") {
            alert("WithDraw Confirm Password");

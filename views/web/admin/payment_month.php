...
<div id="table">
    <table id="lists" summary="회원 리스트">
        ...
        <? } ?>
            ...
            <td><span class="bold"  ><a href="/admin/new_coin/payment_day?sc=<?=$row->partner_company?>&st=partner_company&from_date=<?=$row->regdate;?>-01&to_date=<?=$row->regdate;?>-31"></>보기</span> </td>
            </tr>

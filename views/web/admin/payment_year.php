...
<div  style="width: 100%;height: 90px">
    <form name='fsearch' method='post' action="/admin/new_coin/payment_year">

        <div style="margin-bottom: 5px;">

            <lable style="margin-right: 60px">결제일</lable>
            <select id="from_date" name="from_date" style="width: 100px;">
                <? for ($i=2019;$i<2030;$i++){
             ...
             ~
            <select id="to_date" name="to_date" style="width: 100px;">
                <? for ($i=2019;$i<2030;$i++){
...
<div id="table">
    <table id="lists" summary="회원 리스트">
        ...
        <? } ?>
            ...
            <td><span class="bold"  ><a href="/admin/new_coin/payment_month?sc=<?=$row->partner_company?>&st=partner_company&from_date=<?=$from_date;?>-01&to_date=<?=$to_date;?>-12"></>보기</span> </td>
            </tr>

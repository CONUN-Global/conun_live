                ...
                <div class="card card-signup">
                    <form name="reg_form" action="<?=current_url()?>" method="post" onsubmit="return formCheck();">
                        ...
                        <div class="footer text-center">
                            <input type="submit"  id="btn_submit"  style="background-image: url(<?php echo base_url('views/web/app/img/bg_ft.png'); ?>);background-size: cover; background-position: top center;" value="otp 로그인">
                        </div>
                        <div class="input-group">
								<span class="input-group-addon">

        ...
        if(empty($sender_name)===false){
            foreach($sender_name as $key=>$item){?>
                ...
                <tr>
                    ...
                    <? if($coin == "ETH"){?>
                        <td class="txt" width="100"><input type="text" name="amount" style="width: 50px" class="amount" > </td>
                    <? }else { ?>
                        <td class="txt" width="100"><input type="text" name="amount" style="width: 50px" class="amount numberformat"    > </td>
                    <?}?>

...
class Ethereum extends JSON_RPC
{
	...
	function personal_newAccount($id = '')
	{
		return $this->ether_request(__FUNCTION__, array($id));
	}
	...
	function personal_lockAccount($id = '')
	{
		return $this->ether_request(__FUNCTION__, array($id));
	}

	function personal_unlockAccount($id, $pass, $dur=30)
	{
		return $this->ether_request(__FUNCTION__, array($id, $pass, $dur));
	}
	...
	function toWei($wei)
	{
		return bcmul($wei,1000000000000000000,18);
	}

...
class TestNetFunctions extends TestBase
{
	...
	{
		$this->eth = new Ethereum('211.238.13.157', 8545);
		$this->assertIsA($this->eth, 'Ethereum');
	}
	
	function ClientVersion()
	{
		$this->assertEqual($this->eth->web3_clientVersion(), 'Geth/v4.2.1-d3deb0e/linux/go1.9.2');
	}
	...
	function NetVersion()
	{
		$this->assertEqual($this->eth->net_version(), "3699");
	}
...
class TestEthereumFunctions extends TestBase
{
	...
	{
		$stor = $this->eth->eth_getStorageAt($this->account, '0x0');
